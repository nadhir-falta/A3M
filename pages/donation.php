    ...
    <form action="" method="POST" id="payment-form" class="form-horizontal">
      ...
      ?>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-8">
            <label class="control-label" for="textinput"><b>Donation allocation:</b> To designate your donation to a specific fund, please check the boxes bellow. To allow
        ...
        <fieldset>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-3">
              <input type="numer" id="amount" name="amount" placeholder="Amount $" maxlength="10" class="amount form-control">
            </div>
          </div>
...
<div class="wrapper row5">
  <div id="copyright" class="hoc clear"> 
    <p class="fl_left">Copyright &copy; 2016 - All Rights Reserved - <a href="http://www.a3michigan">www.a3michigan.com</a></p>
  </div>
</div>
