...
<div class="bgded overlay" style="background-image:url('../img/backgrounds/membership.jpg');">
    ...
    <section id="breadcrumb" class="hoc clear">
        <h6 class="heading" style="font-size: 3.0vw;">Recover Password</h6>
        <ul>
            <li><a href="../index.html">Home</a></li>
                    ...
                    <form name="frmForgot" action="" id="frmForgot" method="post">
                        ...
                        if ($_POST) {
                            ...
                            if(!empty($user[0])) {
                                ...
                                <br>Click here to reset your password http://www.a3michigan.org/pages/resetPassword.php?encrypt='.$encrypt.'&action=reset&id='.$user[0].'   <br/>
                                 <br/>--<br>Thank You<br>Admin@a3michigan.org.';
                                $headers = "From: info@a3michigan.org\r\n";
                                $headers .= "MIME-Version: 1.0\r\n";
                                $headers .= "Content-Type: text/html; charset=ISO-8859-1\r\n";
                                if (mail($to, $subject, $body, $headers)) {
                                    echo '<script type="text/javascript">window.location.replace("http://www.a3michigan.org/pages/recoverPassword.php?success=true");</script>';
                                } else {
                                    echo '<script type="text/javascript">window.location.replace("http://www.a3michigan.org/pages/recoverPassword.php?failure=true");</script>';
                                }
                            } else {
